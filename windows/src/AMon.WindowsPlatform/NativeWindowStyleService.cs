...
public interface INativeWindowStyleService
{
    void MakeToolWindowNonActivating(Window window);
}

public sealed class NativeWindowStyleService : INativeWindowStyleService
{
    private const int GwlExStyle = -20;
    private const long WsExToolWindow = 0x00000080L;
    private const long WsExNoActivate = 0x08000000L;

    public void MakeToolWindowNonActivating(Window window)
    {
        ...
        SetWindowLongPtr(handle, GwlExStyle, new IntPtr(currentStyle | WsExToolWindow | WsExNoActivate));
    }
