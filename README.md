...
amon은 로컬 AI 코딩 도구의 사용량과 세션을 수집하는 데스크톱 앱입니다.
...
기본 데스크톱 펫은 Amun-Ra에서 영감을 받은 귀여운 `amon` 캐릭터다. macOS와
Windows 앱은 동일한 Codex Pet v3 WebP 스프라이트시트를 번들하며, 표준 9개
상태에 둘러보기 2종과 뒷모습 앞으로 달리기를 더한 12개 애니메이션 행을
로컬에서 재생한다. 사용자가 가져온 커스텀 펫 선택은 우선한다.
